"""
OLD TRACKING CODE. NEEDS TO BE UPDATED FOR NEW VERSION OF PYDRA.
"""

# from pydra_old.core import Plugin, TrackingWorker, TrackingOutput
# from pydra_old.gui.display import Plotter
...
#         self.points_data = self.parent._data["main"].plot([], [], pen=None, symbol='o')
